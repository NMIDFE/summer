(function($) {
    ...
    Dm3ResponsiveSlider.prototype = {
        ...
        init: function() {
             ...
             */
            that.inner.bind('mousedown touchstart',
            function(e) {
                e.preventDefault();
                that.dx = 0;
             ...
             */
            that.inner.bind('mousemove touchmove',
            function(e) {
                var x, scrollTo;

                e.preventDefault();

                if (!that.moving || that.sliding) {
                    return;
                }
             ...
             */
            $('body').bind('mouseup mouseleave touchend',
            function(e) {
                that.onMouseUp(e);
            });
